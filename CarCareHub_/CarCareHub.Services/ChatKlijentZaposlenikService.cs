...
{
    public class ChatKlijentZaposlenikService: BaseCRUDService<Model.ChatKlijentZaposlenik, Database.ChatKlijentZaposlenik, ChatKlijentZaposlenikSearchObject,
        ChatKlijentZaposlenikInsert, ChatKlijentZaposlenikUpdate>, IChatKlijentZaposlenikService
    {
        //private readonly ChatKlijentServis _chatKlijentServis;

        public ChatKlijentZaposlenikService(Database.CchV2AliContext dbContext, IMapper mapper) : base(dbContext, mapper)
        {
        ...
        public override IQueryable<Database.ChatKlijentZaposlenik> AddInclude(IQueryable<Database.ChatKlijentZaposlenik> query, ChatKlijentZaposlenikSearchObject? search = null)
        {
