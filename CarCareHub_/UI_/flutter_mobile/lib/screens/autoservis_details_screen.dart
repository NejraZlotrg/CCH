                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "Cijena: ${usluga.cijena?.toString() ?? ''} KM"),
                                        const SizedBox(height: 4),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                const Color.fromARGB(255, 251, 26, 10),
                    ...
                    if (context.read<UserProvider>().role == "Admin" ||
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                const Color.fromARGB(255, 253, 27, 11),
                            foregroundColor: Colors.white,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10.0),
                            ),
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              ...
                              if (username != null &&
                                ...
                                final exists = await _autoservisProvider
                                    .checkUsernameExists(username);
                                if (exists &&
                                    (widget.autoservis == null ||
                                        widget.autoservis?.username
                                                ?.toLowerCase() !=
                              ...
                              if (_formKey.currentState?.saveAndValidate() ??
                                ...
                                if (_imageFile != null) {
                                  ...
                                  const assetImagePath =
                                      'assets/images/autoservis_prazna_slika.jpg';
                                  var imageFile =
        ...
        return AlertDialog(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FormBuilderTextField(
                      ...
                      obscureText: true,
                      validator: (value) {
                        final password = zaposlenikFormKey
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                final isValid =
                    zaposlenikFormKey.currentState?.validate() ?? false;
                ...
                final password =
                    zaposlenikFormKey.currentState?.fields['password']?.value;
                final passwordAgain = zaposlenikFormKey
                    .currentState?.fields['passwordAgain']?.value;
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        controller:
                            TextEditingController(text: zap.brojTelefona),
                        validator: validator.phoneNumber,
                        decoration:
