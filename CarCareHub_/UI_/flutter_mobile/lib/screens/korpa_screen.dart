...
class _KorpaScreenState extends State<KorpaScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      print('GreÅ¡ka prilikom uÄitavanja podataka iz korpe: $e');
    }
  }
  ...
  void handlePayment(dynamic narudzba) async {
    ...
    try {
      ...
      print('GreÅ¡ka prilikom plaÄ‡anja: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('GreÅ¡ka prilikom plaÄ‡anja: $e')),
      );
    }
  }
  ...
  void handleSubmit(dynamic narudzba) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('NarudÅ¾ba je uspjeÅ¡no kreirana.')),
    );
  }
  ...
  Future<void> _finishOrder() async {
    ...
    try {
      ...
      print('GreÅ¡ka prilikom kreiranja narudÅ¾be: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('GreÅ¡ka prilikom kreiranja narudÅ¾be.')),
      );
    }
  }
  ...
  Widget _buildPlatiButton() {
    return Padding(
      ...
      child: ElevatedButton(
        ...
        child: const Text('ZavrÅ¡i narudÅ¾bu'),
      ),
    );
  }
}