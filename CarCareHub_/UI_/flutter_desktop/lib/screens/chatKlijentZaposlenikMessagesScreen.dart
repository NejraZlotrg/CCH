// ignore_for_file: library_private_types_in_public_api, camel_case_types, deprecated_member_use, use_build_context_synchronously, avoid_print
...
class _ChatMessagesScreenState
  ...
  Future<void> runSignalR() async {
    ...
    connection.on('ReceiveMessageZaposlenikKlijent#$zaposlenikId/$klijentId',
        (arguments) {
      fetchMessages();
    });

    connection.on('ReceiveMessageZaposlenikKlijent#$klijentId/$zaposlenikId',
        (arguments) {
      fetchMessages();
    });
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ...
                      if (message.isNotEmpty) {
                        Provider.of<ChatKlijentZaposlenikProvider>(context,
                                listen: false)
                            .sendMessage(widget.selectedChat.klijentId,
                                widget.selectedChat.zaposlenikId, message)
                            .then((_) {
