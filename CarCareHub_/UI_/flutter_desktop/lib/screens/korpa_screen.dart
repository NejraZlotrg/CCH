      ...
      setState(() {
        ...
        for (var item in korpaList) {
          ...
          if (_userProvider.role == "Autoservis" &&
              item.proizvod?.cijenaSaPopustomZaAutoservis != null &&
              dataWithDiscount!.result
                  .any((p) => p.proizvodId == item.proizvod?.proizvodId)) {
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            if (confirmed) {
              await _finishOrder();
              await _korpaProvider.ocistiKorpu(
                klijentId: _userProvider.role == 'Klijent'
                    ? _userProvider.userId
                    : null,
                zaposlenikId: _userProvider.role == 'Zaposlenik'
                    ? _userProvider.userId
                    : null,
                autoservisId: _userProvider.role == 'Autoservis'
                    ? _userProvider.userId
                    : null,
              );
            }
